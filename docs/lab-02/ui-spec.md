...
| Empty (0 active Requesters) | dropdown replaced by a message: "No active Development Requesters are available. Ask your instructor to check the seed data." — Continue stays disabled (AC-16) |
...
- [ ] Zen Green colors match the token table in §1 on all three screens.
- [ ] Editable vs. read-only fields are visually distinguishable without reading their labels.
- [ ] Validation messages sit directly under their field, never only in a top-of-form summary.
- [ ] Button hierarchy (primary/secondary/tertiary/destructive/disabled/busy) is visually consistent
      across Create Ticket and Ticket Detail.
- [ ] No clipped labels, overlapping messages, or hidden buttons at 375px, 820px, or 1280px widths.
- [ ] No horizontal scrolling of the page body at any of the three widths.
- [ ] Desktop table and mobile card renderings of My Tickets both show the required fields (§7).
- [ ] Priority/Status/Attachment badges are visually consistent wherever they appear.
