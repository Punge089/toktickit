...
// Buppha Ratanakorn is deliberately never a requesterEmail below — the
// Lab 2 E2E/responsive suite (e2e/lab-02/) relies on her having zero
// tickets to exercise the genuine empty-account state, as distinct from
// the no-results-for-a-filter state (AC-11/AC-12).
const SEED_TICKETS: SeedTicket[] = [
  ...
  { ticketNumber: "TKT-2024-000106", requesterEmail: "duangjai.phromma@example.dev", categoryName: "Account and Access", relatedSystemName: "Grade Submission App", summary: "Request access to grade submission", description: "I need read access to the grade submission app for the upcoming semester audit.", requestedPriority: "LOW", itPriority: "LOW", currentStatus: "WAITING_FOR_REQUESTER", ownerEmail: "jennifer.anderson@example.dev" },
  ...
  { ticketNumber: "TKT-2024-000110", requesterEmail: "aran.suksawat@example.dev", categoryName: "Hardware", relatedSystemName: "Corporate Laptop", summary: "Multi-monitor not detected", description: "Only one of my two external monitors is detected after the latest Windows update.", requestedPriority: "MEDIUM", itPriority: "LOW", currentStatus: "IN_PROGRESS", ownerEmail: "david.lee@example.dev" },
  ...
  { ticketNumber: "TKT-2024-000115", requesterEmail: "chai.wongsawat@example.dev", categoryName: "Hardware", relatedSystemName: "Printer", summary: "Print jobs stuck in queue", description: "Print jobs sit in the queue for over 30 minutes before printing, or never print at all.", requestedPriority: "MEDIUM", itPriority: "MEDIUM", currentStatus: "REOPENED", ownerEmail: "michael.brown@example.dev" },
